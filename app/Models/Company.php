...
class Company extends Model
{
    protected $fillable = [
        ...
        'attendance_require_punch_photo',
    ...
    protected function casts(): array
    {
        return [
            ...
            'attendance_require_punch_photo' => 'boolean',
            'attendance_regularization_previous_month_cutoff_day' => 'integer',
            'attendance_regularization_max_requests_per_month' => 'integer',
            'attendance_regularization_block_current_day_until_complete' => 'boolean',
