...
@section('content')
            ...
            <div class="content-card-body">
                <form id="momentsPostForm">
                    <div class="row g-3 mb-3">
                        <div class="col-md-4">
                            <label class="form-label fw-semibold" for="momentsPostType">Moment type</label>
    ...
    <div class="moments-filter-bar mb-3">
        <div class="btn-group flex-wrap moments-filter-group" role="group" aria-label="Filter moments">
