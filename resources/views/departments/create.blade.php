...
@section('title', 'Add Department - ' . config('app.name', 'HRMS'))

@section('header')
    <div class="d-flex flex-wrap align-items-center justify-content-between gap-2">
        <div>
            <h1 class="page-title mb-1">Add Department</h1>
            <p class="page-subtitle mb-0">Create a new department for your company.</p>
        </div>
...
@section('content')
    ...
    <div class="content-card">
        <div class="content-card-body">
            <form id="departmentForm" class="row g-4">
