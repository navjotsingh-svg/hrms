                    ...
                    <tr>
                        <td style="background: linear-gradient(135deg, #1e3a5f 0%, #0f2744 100%); border-radius: 16px 16px 0 0; padding: 32px 36px; text-align: center;">
                            ...
                            <p style="margin: 10px 0 0; color: rgba(255,255,255,0.82); font-size: 15px; line-height: 1.5;">
                                Your employee account is ready on our HRMS platform
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="background: #ffffff; padding: 36px; border-left: 1px solid #e2e8f0; border-right: 1px solid #e2e8f0;">
                            ...
                            <p style="margin: 0 0 24px; font-size: 15px; line-height: 1.7; color: #475569;">
                                ...
                                <strong style="color: #0f172a;">{{ $employee->company?->name }}</strong>.
                                Use the credentials below to sign in and access your HR portal.
                            </p>
                                    ...
                                    <td style="padding: 18px 20px;">
                                        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                                            ...
                                            <tr>
                                                ...
                                                <td style="padding: 8px 0; font-size: 14px; color: #0f172a; font-weight: 600;">{{ $employee->email }}</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td style="padding: 8px 0; font-size: 13px; font-weight: 600; color: #64748b; vertical-align: top;">Employee Code</td>
                                                <td style="padding: 8px 0; font-size: 14px; color: #0f172a;">{{ $employee->employee_code }}</td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 8px 0; font-size: 13px; font-weight: 600; color: #64748b; vertical-align: top;">Role</td>
                                                <td style="padding: 8px 0; font-size: 14px; color: #0f172a;">{{ $employee->role?->name ?? 'Employee' }}</td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                    ...
                    <tr>
                        <td style="background: #ffffff; border: 1px solid #e2e8f0; border-top: none; border-radius: 0 0 16px 16px; padding: 24px 36px 32px; text-align: center;">
                            <p style="margin: 0 0 6px; font-size: 14px; color: #64748b; line-height: 1.6;">
                                Need help? Contact your company administrator or reply to this email.
                            </p>
