...
@section('title', 'Edit Holiday - ' . config('app.name', 'HRMS'))

@section('header')
    <div class="d-flex flex-wrap align-items-center justify-content-between gap-2">
        <div>
            <h1 class="page-title mb-1">Edit Holiday</h1>
            <p class="page-subtitle mb-0">Update holiday details for the attendance calendar.</p>
        </div>
...
@section('content')
    ...
    <div class="content-card">
        <div class="content-card-body">
            <form id="holidayForm" class="row g-4" data-holiday-id="{{ $holidayId }}">
                @include('holidays.partials.form')
                <div class="col-12 d-flex gap-2">
                    <button type="submit" class="btn btn-primary" id="holidaySubmitBtn">Update Holiday</button>
