...
@section('performance-content')
        ...
        <div class="table-responsive">
            <table class="companies-table table mb-0">
                ...
                <tbody id="kpiTableBody">
                    <tr><td colspan="{{ $canManage ? 8 : 7 }}" class="text-center text-muted py-4">Loading…</td></tr>
                </tbody>
            </table>
        </div>
    ...
    <div class="modal fade" id="kpiProgressModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="kpiProgressModalLabel">Update KPI Progress</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                <form id="kpiProgressForm" class="modal-body">
                    <input type="hidden" id="kpiProgressEditingId">
                    <div class="row g-3">
                        <div class="col-12">
                            <label class="form-label">KPI</label>
                            <p class="form-control-plaintext fw-medium mb-0" id="kpiProgressTitle">—</p>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Target</label>
                            <p class="form-control-plaintext mb-0" id="kpiProgressTarget">—</p>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label" for="kpiProgressCurrent">Current *</label>
                            <input type="number" class="form-control" id="kpiProgressCurrent" min="0" step="0.01" required>
                        </div>
                        <div class="col-12">
                            <p class="text-muted small mb-0" id="kpiProgressMeta"></p>
                        </div>
                        <div class="col-12 d-none" id="kpiLinkedGoalsWrap">
                            <label class="form-label">Linked goals</label>
                            <div id="kpiLinkedGoalsList" class="small"></div>
                            <p class="form-text mb-0">Updating this KPI will automatically refresh linked goal tasks and goal achievement %.</p>
                        </div>
                    </div>
                </form>
                <div class="modal-footer">
                    <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal">Cancel</button>
                    <button type="submit" form="kpiProgressForm" class="btn btn-primary">Save Progress</button>
                </div>
            </div>
        </div>
    </div>
